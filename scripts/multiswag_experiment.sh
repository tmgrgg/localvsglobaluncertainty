...
test $SGE_TASK_ID -eq 1 && sleep 10 && PYTHONPATH=. python3 experiments/train_multiswag/experiment.py --dir='/content/drive/My Drive/LocalVsGlobalUncertainty/Experiments/FashionMNIST/DenseNet/2f' \
